...
<div class="space-y-5">
    <div class="rounded-xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-950">
        ...
        <div class="mt-2 text-sm text-gray-600 dark:text-gray-400">
            Current status:
            <span class="ml-2 inline-flex items-center rounded-full border px-3 py-1 text-xs font-semibold {{ $application->status?->badgeClasses() ?? 'border-gray-200 bg-gray-50 text-gray-800 dark:border-gray-800 dark:bg-gray-950/40 dark:text-gray-200' }}">
        ...
        <div class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            Feedback: <span class="font-medium text-gray-950 dark:text-white">
                {{ $application->status?->isRejected() ? 'Your application was not selected. Review the job detail for next steps.' : 'No public feedback yet.' }}
            </span>
        </div>
    </div>
